...
Reference 1: [How to decrypt SSL/TLS traffic using Wireshark and private keys?](./kb-1070)

Reference 2: [How to decrypt SSL/TLS using Wireshark and SSLKEYLOGFILE environment variable on Firefox or Google Chrome using Wireshark?](./kb-1071) 