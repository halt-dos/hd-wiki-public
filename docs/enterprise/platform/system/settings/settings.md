...
1. [**Task Management**](/enterprise/platform/system/settings/task_mgmt)
...
5. [**Log Exporter**](/enterprise/platform/system/settings/log_exporter)
6. [**Forensics**](/enterprise/platform/system/settings/forensics)
7. [**Actions**](/enterprise/platform/system/settings/actions)
