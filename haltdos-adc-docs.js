...
const PATHS = [
  '/adc/',
  '/adc/listeners/',
  '/adc/listeners/ssl_settings',
  '/adc/listeners/geo_filtering',
  '/adc/listeners/server_groups/',
  '/adc/listeners/server_groups/servers',
  '/adc/listeners/server_groups/load_balancing',
  '/adc/listeners/server_groups/snmp',
  '/adc/listeners/monitors',
  '/adc/listeners/performance',
];
...
(async () => {
  ...
  await mergePDFs(pdfBuffers, path.join(__dirname, 'haltdos-enterprise-adc-docs.pdf'));
