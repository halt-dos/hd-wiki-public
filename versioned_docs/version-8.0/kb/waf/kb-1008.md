...
2. Specify the anticipated max file size that will be uploaded in Maximum HTTP Body Size on [**Settings**](../../enterprise/waf/listener/Setting/operational.md) page.
