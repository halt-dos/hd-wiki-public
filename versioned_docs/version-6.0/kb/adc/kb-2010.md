---
title: "Restrict Backend Access by IP | Haltdos ADC KB"
description: "Allow access to backend web applications only from trusted IP addresses using Haltdos ADC access rules."
---
