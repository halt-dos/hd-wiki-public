---
title: "Add Multiple Server Groups | Haltdos ADC KB"
description: "Learn how to configure multiple server groups for load balancing, failover, and application availability."
---
