---
title: "Gracefully Disable Backend Servers | Haltdos ADC KB"
description: "Learn how to gracefully remove backend servers from service without interrupting active user sessions."
---
