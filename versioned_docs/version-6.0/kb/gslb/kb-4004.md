---
title: "Block Malicious Domains | Haltdos GSLB KB"
description: "Learn how to use the DNS resolver to block access to malicious websites and improve network security."
---
